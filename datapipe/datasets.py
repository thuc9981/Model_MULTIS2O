...
from basicsr.data.dualband_sar_dataset import DualBandSARDataset
...
def create_dataset(dataset_config):
    if dataset_config['type'] == 'gfpgan':
        ...
        dataset = PairedImageDataset(dataset_config)
    elif dataset_config['type'] == 'SingleImageDataset':
        dataset = SingleImageDataset(dataset_config)
    elif dataset_config['type'] == 'DualBandSARDataset':
        dataset = DualBandSARDataset(dataset_config)
    elif dataset_config['type'] == 'MultiSARDataset':
        dataset = MultiSARDataset(dataset_config)
    else:
